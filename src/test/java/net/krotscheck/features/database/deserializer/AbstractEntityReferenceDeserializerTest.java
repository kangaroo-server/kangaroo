...
package net.krotscheck.features.database.deserializer;
...
import net.krotscheck.test.entity.TestChildEntity;
import net.krotscheck.test.entity.TestPrivateEntity;
