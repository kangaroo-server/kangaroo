...
import net.krotscheck.features.exception.mapper.HttpStatusExceptionMapper;
import net.krotscheck.features.exception.mapper.JerseyExceptionMapper;
import net.krotscheck.features.exception.mapper.JsonParseExceptionMapper;
import net.krotscheck.features.exception.mapper.UnhandledExceptionMapper;
...
public final class ExceptionFeature implements Feature {
    ...
    public boolean configure(final FeatureContext context) {
        ...
        // Exception mappers.
        context.register(new HttpStatusExceptionMapper.Binder());
